...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DISCIPLINE_LIST actions', async () => {
    ...
    it('dispatches FETCH_DISCIPLINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DISCIPLINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DISCIPLINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DISCIPLINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DISCIPLINE actions', async () => {
      const expectedActions = [
        {
