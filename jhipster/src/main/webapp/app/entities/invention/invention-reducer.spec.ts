...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './invention.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INVENTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_INVENTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INVENTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INVENTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INVENTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INVENTION actions', async () => {
      const expectedActions = [
        {
