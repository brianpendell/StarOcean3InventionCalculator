...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './inventor.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INVENTOR_LIST actions', async () => {
    ...
    it('dispatches FETCH_INVENTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INVENTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INVENTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INVENTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INVENTOR actions', async () => {
      const expectedActions = [
        {
