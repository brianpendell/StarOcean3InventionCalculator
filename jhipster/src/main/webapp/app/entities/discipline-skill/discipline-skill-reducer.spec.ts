...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DISCIPLINESKILL_LIST actions', async () => {
    ...
    it('dispatches FETCH_DISCIPLINESKILL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DISCIPLINESKILL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DISCIPLINESKILL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DISCIPLINESKILL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DISCIPLINESKILL actions', async () => {
      const expectedActions = [
        {
